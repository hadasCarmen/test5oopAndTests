...
function management() {
  const flight1 = new Flight("one", "arkia", "one", 50, 100, 150,300);
  const flight2 = new Flight("two", "elal", "two", 10, 15, 20,400);
  const flight3 = new Flight("three", "wizz", "three", 5, 50, 500,200);
